...
# with a width of 480 pixels and a height of 480 pixels containing Plot 2 as specified
...
# Define function plot2() that will output the PNG file containing Plot 2

	plot2<-function(dataset, plotfile) {
...
# Create Plot 2
	...
	print("Script executed successfully, plot saved to plot2.png in working directory")