...
# with a width of 480 pixels and a height of 480 pixels containing Plot 4 as specified
...
# Define function plot4() that will output the PNG file containing Plot 4

	plot4<-function(dataset, plotfile) {
		 ...
		 # Set English US locale
		  ...
		  # Create Voltage x DateTime plot
		  plot(dataset$DateTime, dataset$Voltage, type = "l",
		       xlab = "datetime", ylab = "Voltage")
		  
		  print("VxDT plot created")
		       
		  # Create Global_reactive_power x DateTime plot
		  plot(dataset$DateTime, dataset$Global_reactive_power, type = "l",
		       xlab = "datetime", ylab = "Global_reactive_power")
		  
		  print("GRPxDT plot created")     
